    ...
    <div class="flex flex-col flex-grow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">  
            <div class="col-span-1">
                ...
                <div class="flex flex-col m-10 border-2 p-5 border-[#80747475] rounded-lg gap-3 shadow-[0_2px_4px_rgba(0,0,0,0.1)]">
        ...
        <div class="mx-auto w-fit border-2 p-5 border-[#80747475] rounded-lg gap-3 shadow-[0_2px_4px_rgba(0,0,0,0.1)] m-3">
            <p class="text-lg font-bold">Status Akademik: 
                <span>{{Str::upper(Auth::user()->mahasiswa->status)}}</span>
            </p>
        </div>
    </div>
@include('footer')
